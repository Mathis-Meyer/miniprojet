...
public class Categorie {
	...
	@ToString.Exclude // Important : Empêche Lombok de faire planter l'application en essayant d'afficher les fournisseurs en boucle
    @ManyToMany(mappedBy = "categories") // Fait le lien avec la liste "categories" dans l'entité Fournisseur
    @JsonIgnoreProperties("categories") // Important : Empêche une boucle infinie quand on transforme en JSON
